    ...
    $.extend($.timeago, {
        ...
        daysInWords : function(datePassed, distanceMillis) {
            ...
            var getWeekDay = function(datePassed) {
                ...
                return ($.timeago.settings.additionalStrings[day.toLowerCase()]) || "today";
            };
            ...
            var getDate = function(datePassed) {
                ...
                var d = date.getDate();
                var monthMapping = {
                    0   : $.timeago.settings.additionalStrings.jan,
                    1   : $.timeago.settings.additionalStrings.feb,
                    2   : $.timeago.settings.additionalStrings.march,
                    3   : $.timeago.settings.additionalStrings.april,
                    4   : $.timeago.settings.additionalStrings.may,
                    5   : $.timeago.settings.additionalStrings.june,
                    6   : $.timeago.settings.additionalStrings.july,
                    7   : $.timeago.settings.additionalStrings.august,
                    8   : $.timeago.settings.additionalStrings.sep,
                    9   : $.timeago.settings.additionalStrings.oct,
                    10  : $.timeago.settings.additionalStrings.nov,
                    11  : $.timeago.settings.additionalStrings.dec
                };
                return monthMapping[month] + " " + d;
            };

            var strings = $.timeago.settings.additionalStrings;
            ...
            // var ourOwnWords = Math.round(days) == 0 ? $.timeago.settings.additionalStrings.today : (days < 6 ? getWeekDay(days) : getDate(datePassed));
            return (ourOwnWords);
        },
